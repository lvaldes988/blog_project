...
<body>
<h2>Nueva entrada</h2>
<form action="../controller/Transaction.php" method="post" enctype="multipart/form-data" name="form1">
<table >
<tr>
  <td>Título: 
  ...
  <tr>
  <td colspan="2" align="center">Seleccione una image con tamaño inferior a 2 MB</td></tr>
  <tr>
